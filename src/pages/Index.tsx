...
import { ArrowRight, HardDrive, Network, Server, Computer,PlugZap, Monitor, Cpu,Printer, Shield, Settings, Check, Mouse,Keyboard,ArrowUpRight, Image, GalleryHorizontal } from "lucide-react";
...
const Index = () => {
    ...
    const productCategories = [
  {
    ...
    description: "Essential cable accessories including adapters, extenders, and cable management tools.",
    image: "/images/products/cable_accesries.png",
    popular: true,
  },
  {
    id: 2,
    name: "Office Stationery & Tools",
    icon: <HardDrive className="h-8 w-8" />,
    description: "Modern desk accessories and organizational tools to enhance your workspace setup.",
    image: "/images/products/modern-stationary-collection-arrangement.png",
    popular: false,
  },
  {
    id: 3,
    ...
    description: "High-capacity server rack solutions for businesses and data centers.",
    image: "/images/products/server-rack1.png",
    popular: true,
  },
  {
    id: 4,
    ...
    description: "Reliable fax machines for traditional and secure document transmission.",
    image: "/images/products/fax.png",
    popular: false,
  },
  {
    id: 5,
    ...
    icon: <Server className="h-8 w-8" />,
    description: "Powerful rack servers and accessories for enterprise-level computing infrastructure.",
  ...
  },
  {
    ...
    description: "Professional routers, switches, and cable solutions for stable and secure connectivity.",
    image: "/images/products/network-switch-with-cables (1).jpg",
    popular: false,
  },
  {
    id: 7,
    ...
    description: "All-in-one personal computers ideal for work, learning, and home use.",
    image: "/images/products/personal-computer.png",
    popular: false,
  },
  {
    id: 8,
    ...
    description: "High-resolution scanners for converting paper documents into digital formats.",
    image: "/images/products/scanner1.png",
    popular: true,
  },
    ...
    icon: <PlugZap className="h-8 w-8" />,
    description: "Switches for managing network traffic across multiple devices efficiently.",
    image: "/images/products/netwrokswitches.jpg",
    popular: true,
  },
  {
    id: 10,
  ...
  },
  {
    ...
    name: "Router",
    icon: <Server className="h-8 w-8" />,
    description: "Device that connects multiple networks and directs data traffic.",
  ...
  },
  {
    ...
    name: "UPS",
    icon: <Printer className="h-8 w-8" />,
    description: "Uninterruptible power supply for protecting electronics from power outages.",
  ...
  },
  {
    ...
    icon: <Monitor className="h-8 w-8" />,
    description: "Handheld device for controlling video games.",
    image: "/images/products/game-controller.png",
    popular: false,
  },
  {
    id: 16,
    name: "CAT5e RJ45 Faceplate",
    icon: <Mouse className="h-8 w-8" />,
    description: "Wall faceplate with CAT5e RJ45 port for clean network setups.",
    image: "/images/products/cat5e-utp-rj45-loaded-metal-faceplates.png",
    popular: true,
  },
  {
    id: 17,
    name: "Trackball",
    icon: <Mouse className="h-8 w-8" />,
    description: "Input device with a rolling ball for precise cursor control.",
    image: "/images/products/trackballs.png",
    popular: true,
  },
  {
    id: 18,
...
const [selectedCategory, setSelectedCategory] = useState<number | null>(null);
    ...
    return (
      ...
      <section id="product-categories" className="py-20 bg-slate-900 relative overflow-hidden" >
      ...
      <Card className="border-slate-700/50 bg-slate-800/50 overflow-hidden relative">
        <div className="relative aspect-square overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-slate-900/95 to-transparent flex items-end">
                                ...
                                <CarouselItem className="sm:basis-1/2 lg:basis-1/3">
                                    <div className="p-1">
                                        <Card className="border-slate-700/50 bg-slate-800/50 overflow-hidden">
                                            <div className="relative aspect-square overflow-hidden">
                                                <img
                                                    src='/images/products/server-hardware.webp'
                                                    alt="Server Hardware"
                                ...
                                <CarouselItem className="sm:basis-1/2 lg:basis-1/3">
                                    <div className="p-1">
                                        <Card className="border-slate-700/50 bg-slate-800/50 overflow-hidden">
                                            <div className="relative aspect-square overflow-hidden">
                                                <img
                                                    src='/images/products/storage-system.jpg'
                                ...
                                <CarouselItem className="sm:basis-1/2 lg:basis-1/3">
                                    <div className="p-1">
                                        <Card className="border-slate-700/50 bg-slate-800/50 overflow-hidden">
                                            <div className="relative aspect-square overflow-hidden">
                                                <img
                                                    src='/images/products/networking.webp'
                                ...
                                <CarouselItem className="sm:basis-1/2 lg:basis-1/3">
                                    <div className="p-1">
                                        <Card className="border-slate-700/50 bg-slate-800/50 overflow-hidden">
                                            <div className="relative aspect-square overflow-hidden">
                                                <img
                                                    src='/images/products/display.avif'
            ...
            {/* Why Choose Us */}
            <section ref={featuresRef} className="bg-slate-900 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                        ...
                        <FeatureCard
                            ...
                            description="Tailored hardware solutions built to your exact specifications and business requirements."
