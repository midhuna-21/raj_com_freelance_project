                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center space-x-6 text-sm">
                            ...
                            <div className="flex items-center">
                                ...
                                <span>Raj Computer System PO Box: 111013 , Dubai</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex items-center justify-between py-4">
                        <div className="flex items-center">
                            <Link to="/" className="flex items-center">
                                <AnimatedLogo />
                                <div className="ml-2">
                                    <span className="block text-xl font-bold text-white">RAJ COMPUTER SYSTEMS</span>
                        ...
                        <div className="lg:hidden py-4 animate-slide-in bg-slate-900/95 backdrop-blur-md">
                            <div className="flex flex-col space-y-3">
                                ...
                                <div className="px-4 py-2 border-t border-slate-700 mt-2 space-y-2">
                                    ...
                                    <div className="flex items-center text-sm text-gray-400">
                                        <Mail className="h-4 w-4 mr-2" />
                                        <span>info@rajnetworks.com</span>
                                    </div>
                                    <div className="flex items-center text-sm text-gray-400">
                                        <MapPin className="h-4 w-4 mr-2" />
                                        <span>Raj Computer System PO Box: 111013 , Dubai</span>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="animate-fade-in" style={{ animationDelay: "100ms" }}>
                            <h3 className="text-xl font-semibold mb-4">RAJ Hardware</h3>
                    ...
                    <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
                        <p>&copy; {new Date().getFullYear()} RAJ Computer System & Hardware Trading LLC. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
